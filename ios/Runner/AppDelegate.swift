...
//     BTAppContextSwitcher.setReturnURLScheme("com.tqniait.industrialSoooq.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.tqniait.industrialSoooq.braintree") == .orderedSame {
